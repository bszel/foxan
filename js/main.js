...
class Foxan {
    constructor() {
        ...
        this.player = createCircle(0, 500, 300, 30, { color: '#ffffff', isPlayer: true, mass: 10, friction: 0.5, rotatable: false });
        this.ground = createRectangle(1, 700, 700, 1600, 50, { color: '#000000', rotation: 45 });
        this.rect1 = createRectangle(2, 800, 500, 50, 200, { color: '#00ff00', isDynamic: true, rotation: -0, mass: 10 });
    ...
    update() {
        ...
        solveConstraints(this.contacts);
